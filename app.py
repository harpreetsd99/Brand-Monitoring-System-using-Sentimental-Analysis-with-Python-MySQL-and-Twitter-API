...
app.layout = html.Div(children=[
    ...
    html.Div(
        className='row',
        children=[ 
            dcc.Markdown("__Author's Words__: If you like it, I would appreciate for starring⭐️ my project on [GitHub](https://github.com/https://github.com/harpreetsd99?tab=repositories)!✨"),
    ...
    html.Div(
        ...
        children=[
            ...
            html.Div(
                ...
                children=[
                    ...
                    html.A(
                        'GitHub',
                        href='https://github.com/harpreetsd99?tab=repositories'
                    )                    
                ]
            ),
            html.Div(
        ...
        ], style={'marginLeft': 70, 'fontSize': 10}
    ),
                    ...
                    children=[
                        ...
                        html.Div(
                            children=[
                                ...
                                html.P("Currently tracking \"Playstation\"- on Twitter in Pacific Daylight Time (PDT).",
                                    style={
                                        'fontSize': 25
                                    }
                                ),
